...
QUAN_LEVELS = [1, 10, 100]
RESULTS_FILE = ['E10_M10_s{}'.format(x) for x in QUAN_LEVELS]
    ...
    for file in files:
        for i, rfile in enumerate(RESULTS_FILE):
            if rfile == file:
                ...
                result_dict[str(QUAN_LEVELS[i])] = load_dict['loss_on_train_data']
